...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="icon/css/coba.css">
  <!-- Ionicons -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link"><strong>APLIKASI BENDAHARA SMP FUTUHIYYAH MRANGGEN</strong></a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="Logo Futuhiyyah" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light"><strong>SMP FUTUHIYYAH</strong></span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="https://smpfutuhiyyah.sch.id">SMP FUTUHIYYAH MRANGGEN</a>.</strong>
    All rights reserved.
